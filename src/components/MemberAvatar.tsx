...
export function MemberAvatar({
  ...
  return (
    <div className={`relative inline-flex ${shellSize} items-center justify-center`}>
      <div className="flex h-full w-full items-center justify-center rounded-full p-1 shadow-sm" style={shellStyle}>
        <div
          className={`${avatarSize} flex shrink-0 items-center justify-center overflow-hidden rounded-full bg-white text-3xl font-bold transition duration-300 ${
            isOnline ? '' : 'grayscale'
          }`}
          style={avatarStyle}
        >
